...
using static UniCare.Data.Model.Enum;
...
namespace UniCare.Areas.Staff.Pages.Dashboard
{
    ...
    public class AcceptanceStatusModel : PageModel
    {
        ...
        public AcceptanceStatusModel(UniCare.Data.ApplicationDbContext context, IWebHostEnvironment hostingEnv, UserManager<Profile> userManager)
        {
            _context = context;
